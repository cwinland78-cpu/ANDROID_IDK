    ...
    <View className="flex-1 bg-black">
      ...
      >
        ...
        <View className="rounded-2xl bg-white/5 p-5 border border-white/10 mb-4">
          ...
          <Text className="text-sm leading-5 text-white/60">
            All payment processing is handled securely by Apple (App Store) or Google (Play Store), depending on your device. We do not collect, store, process, or have access to your payment card details, billing address, or other financial information. Purchase history is managed by Apple or Google and RevenueCat to verify your premium status.
          </Text>
        </View>
        ...
        <View className="rounded-2xl bg-white/5 p-5 border border-white/10 mb-4">
          ...
          <Text className="text-sm leading-5 text-white/60">
            <Text className="font-semibold text-white">Maps:</Text> Apple Maps (iOS) or Google Maps (Android) opens when you request directions. Subject to each provider's privacy policy.
          </Text>
        </View>
        ...
        <View className="rounded-2xl bg-white/5 p-5 border border-white/10">
          ...
          <Text className="text-xs leading-5 text-white/40 mb-3">
            INTERNATIONAL USERS: {APP_NAME} is available worldwide. All data is stored locally on your device regardless of your location. Third-party services (Google AdMob, RevenueCat, Apple App Store, Google Play, Apple Maps, Google Maps) may process data in accordance with their respective privacy policies.
          </Text>
