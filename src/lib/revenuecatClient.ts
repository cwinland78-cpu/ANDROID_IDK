 ...
 *
 * Platform Support:
 * - Android: Supported via Google Play
...
// Check for environment keys (supports both Vibecode and standard naming)
const testKey =
  process.env.EXPO_PUBLIC_REVENUECAT_TEST_KEY ||
  process.env.EXPO_PUBLIC_VIBECODE_REVENUECAT_TEST_KEY;
